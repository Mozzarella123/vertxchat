...
import static vertx.chat.server.DatabaseConstants.*;
...
public class AuthInitializerVerticle extends AbstractVerticle {
    ...
    public void start() throws Exception {
        ...
        JDBCClient dbClient = JDBCClient.createShared(vertx, new JsonObject()
                .put("url", config().getString(CONFIG_CHATDB_JDBC_URL, DEFAULT_CHATDB_JDBC_URL))
                .put("driver_class", config().getString(CONFIG_CHATDB_JDBC_DRIVER_CLASS, DEFAULT_CHATDB_JDBC_DRIVER_CLASS))
                .put("max_pool_size", config().getInteger(CONFIG_CHATDB_JDBC_MAX_POOL_SIZE, DEFAULT_JDBC_MAX_POOL_SIZE)));
